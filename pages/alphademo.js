        ...
        <div className="md:w-2/3 w-4/5">
          ...
          <div className="mt-6 border-b-2 py-6">
            ...
            <div className="flex flex-col items-center">
                ...
                <a href="/characterpage/index.html" className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">DOWNLOAD MULTIPLAYER HD PC ALPHA DEMO                       <div className=" p-2 w-1/2"><img src="images/BG2.jpg" alt="" width="1200px" className="feature-image"/></div> </a>
                <a href="/characterpage/index.html" className="mt-4 Poppitandfinchsans text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">PLAY SMALLER SINGLE PLAYER BROWSER VERSION                       <div className=" p-2 w-1/2"><img src="images/bG3.jpg" alt="" width="1200px" className="feature-image"/></div> </a>
